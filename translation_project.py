...
clean_dir_name = dir_name + "_CleanOutput"  # Name of the directory the clean tweet files are in
clean_tweet_col = tweet_col + "_Clean"  # Name of the column the clean tweet text is in
